...
Begin VB.Form frmPayroll 
   ...
   Begin VB.OptionButton opt 
      BackColor       =   &H00FFFFFF&
      Caption         =   "Apply Deductions Except Loans"
      Height          =   375
      Left            =   5760
      TabIndex        =   37
      TabStop         =   0   'False
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00C0C0C0&
      Caption         =   "Total Overtime Hours Reported"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00C0C0C0&
      Caption         =   "Total Regular Hours Reported"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
...
Private Sub Form_Load()
    ...
    Me.Icon = frmNewEmployee.SmallImages.ListImages(17).Picture
End Sub
